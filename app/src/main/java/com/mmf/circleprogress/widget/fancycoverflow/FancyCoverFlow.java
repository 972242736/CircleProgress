...
package com.mmf.circleprogress.widget.fancycoverflow;
...
public class FancyCoverFlow extends Gallery {
    ...
    private float reflectionRatio = 0.2f;
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        this.unselectedScale = a.getFloat(R.styleable.FancyCoverFlow_unselectedScale, 0.90f);
    }
...
//        	System.out.println(unselectedScale);
