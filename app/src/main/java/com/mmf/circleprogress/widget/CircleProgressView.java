...
public class CircleProgressView extends View implements ISmoothTarget {
...
//    public MagicProgressCircleTest(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//                canvas.drawArc(rectF, 180, 180f, true, endPaint);
//                canvas.restore();
//            }
